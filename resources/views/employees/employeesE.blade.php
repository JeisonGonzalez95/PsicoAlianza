                ...
                <div class="row mb-5">
                    ...
                    <div class="col-md-4">
                        <select name="state" id="state" class="form-control">
                            ...
                            <option value="{{ $state->id }}" {{ $employee->departament_id == $state->id ? 'selected' : '' }}>
                                {{ $state->name_state }}
                            </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-4">
                        <select name="city" id="city" class="form-control" disabled data-selected-city="{{ $employee->city_id ?? '' }}">
